<?php   include "../../connection/connection.php";
        ...
        if($conn){
            ...
            if(($name == '') || ($lastname == '') || ($email == '') || ($telephone_1 == '') || ($telephone_2 == '') || ($cellphone == '') || ($office_number == '') || ($charge == '') || ($organism == '')){
                echo 5; // hay campos sin completar
            }else{
                $oneContact->addContact($oneContact,$name,$lastname,$email,$telephone_1,$telephone_2,$cellphone,$office_number,$charge,$organism,$conn,$dbase);
            }
